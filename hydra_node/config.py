...
def load_module(path, device):
    ...
    # }
    network = {
        768: (HyperLogic(768), HyperLogic(768)),
        1280: (HyperLogic(1280), HyperLogic(1280)),
        640: (HyperLogic(640), HyperLogic(640)),
        320: (HyperLogic(320), HyperLogic(320)),
    }
...
def init_config_model():
    ...
    config.penultimate = os.getenv('PENULTIMATE', "1")
